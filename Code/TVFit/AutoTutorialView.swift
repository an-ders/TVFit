...
struct AutoTutorialView: View {
    ...
    var title  = "Tutorial for Automatic AR"
    var descriptions = ["Sit on your couch, or your desired sitting distance from your TV.",
                        "Hold your phone at eye level, and aim it towards where you want your TV to be.",
    "Confirm your distance, ensuring that the box is solid.",
    "View the recommended TV sizes for your distance, and apply it. You can also move it around."]
    
    var body: some View {
        
        let screenSize: CGRect = UIScreen.main.bounds
        let descriptionsLen = descriptions.count
        ...
        VStack {
            ...
            VStack {
                switch screen {
                case 4:
                    Animation(name: "AutoAnimation", num: screen)
...
struct AutoTutorial_Previews: PreviewProvider {
    static var previews: some View {
        Spacer()
        //AutoTutorialView(topOff: 44.0, botOff: 30.0)
    }
}
